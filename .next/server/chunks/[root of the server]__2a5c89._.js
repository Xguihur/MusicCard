...
"[project]/utils/retry.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function retry(fn, options = {}) {
    // 设置默认选项
    const { maxAttempts = 3, initialDelay = 1000, maxDelay = 10000, backoff = 2 } = options;
    let lastError = null;
...
"[project]/types/music.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/music/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$retry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/retry.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$music$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/types/music.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        // 根据平台获取音乐信息
        switch(platform){
            case __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$music$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MusicPlatform"].NETEASE:
                {
                    console.log("开始获取网易云音乐信息:", musicId);
                    try {
                        // 使用重试机制获取歌曲详情
                        const songDetail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$retry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["retry"])(async ()=>{
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`http://music.163.com/api/song/detail/?id=${musicId}&ids=[${musicId}]`, {
                        ...
                        // 使用重试机制获取歌词
                        const lyricsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$retry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["retry"])(async ()=>{
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`http://music.163.com/api/song/lyric?id=${musicId}&lv=1&kv=1&tv=-1`, {
                                headers: NETEASE_HEADERS
                            });
                            return response.data;
                        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2a5c89._.js.map